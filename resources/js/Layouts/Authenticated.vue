            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <BreezeResponsiveNavLink :href="route('purchases.create')" :active="route().current('purchasese.create')">
                            購入画面
                        </BreezeResponsiveNavLink>
                        <BreezeResponsiveNavLink :href="route('purchases.index')" :active="route().current('purchasese.index')">
                            購買履歴
                        </BreezeResponsiveNavLink>
